#############################################################################
##  
##  PackageInfo.g for the package `kbmag'                     Derek Holt
##  
...
##  example/init.g, ...    or  example-1.4/init.g, ...  )
# 
ArchiveURL := 
        "http://www.warwick.ac.uk/~mareg/kbmag/kbmag-1.5",
...
Persons := [
  rec( 
    ...
    WWWHome := "http://www.warwick.ac.uk/~mareg",
...
#
README_URL := 
      "http://www.warwick.ac.uk/~mareg/kbmag/README.kbmag",
PackageInfoURL := 
      "http://www.warwick.ac.uk/~mareg/kbmag/PackageInfo.g",
...
PackageWWWHome := "http://www.warwick.ac.uk/~mareg/kbmag",
...
PackageDoc := rec(
  ...
  Archive := 
      "http://www.warwick.ac.uk/~mareg/kbmag/kbmag-1.5.tar.gz",
...
Keywords := ["Knuth-Bendix","Automatic Groups"]
